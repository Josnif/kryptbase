    ...
    return (
        <nav className="w-full flex md:justify-center justify-between items-center p-4">
            ...
            <div className="flex relative">
                {toggelMenu 
                    ?  <AiOutlineClose fontSize={28} className="dark:text-white md:hidden cursor-pointer" onClick={() => setToggleMenu(false)} />
                    : <HiMenuAlt4 fontSize={28} className="dark:text-white md:hidden cursor-pointer" onClick={() => setToggleMenu(true)} />
                }
                {toggelMenu && (
                    <ul
